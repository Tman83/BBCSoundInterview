 ...
 */
     ...
     */
    public static java.util.List<String> dropdownOptionsAsString(WebElement dropdownElement) {
        Select select = new Select(dropdownElement);

        //List of all ACTUAL month <options> as a web element
        java.util.List<WebElement> actualOptionsAsWebElement = select.getOptions();

        //List of all ACTUAL month <options> as a string
        java.util.List<String> actualOptionsAsString = new ArrayList<>();
     ...
     */
    public static void clickRadioButton(java.util.List<WebElement> radioButtons, String attributeValue) {
     ...
     */
    public static java.util.List<String> getElementsText(java.util.List<WebElement> list) {
        java.util.List<String> elemTexts = new ArrayList<>();
    ...
    public static java.util.List<WebElement> getElement(java.util.List<WebElement> list) {
        java.util.List<WebElement> elemTexts = new ArrayList<>();
        for (WebElement el : list) {
            elemTexts.add(el);
        }
        return elemTexts;
    ...
    public static java.util.List<String> getElementsText(By locator) {
        ...
        java.util.List<WebElement> elems = Driver.getDriver().findElements(locator);
